...
func (*Key) Descriptor() ([]byte, []int) { return fileDescriptorAuthq, []int{0} }
...
func (*Value) Descriptor() ([]byte, []int) { return fileDescriptorAuthq, []int{1} }
...
func (*WriteResp) Descriptor() ([]byte, []int) { return fileDescriptorAuthq, []int{2} }

func init() {
	proto.RegisterType((*Key)(nil), "byzq.Key")
	proto.RegisterType((*Value)(nil), "byzq.Value")
	proto.RegisterType((*WriteResp)(nil), "byzq.WriteResp")
}
...
type QuorumSpec interface {
	...
	WriteQF(replies []*WriteResp) (*WriteResp, bool)
}
...
// Client API for AuthRegister service

type AuthRegisterClient interface {
	Read(ctx context.Context, in *Key, opts ...grpc.CallOption) (*Value, error)
	Write(ctx context.Context, in *Value, opts ...grpc.CallOption) (*WriteResp, error)
}

type authRegisterClient struct {
	cc *grpc.ClientConn
}

func NewAuthRegisterClient(cc *grpc.ClientConn) AuthRegisterClient {
	return &authRegisterClient{cc}
}

func (c *authRegisterClient) Read(ctx context.Context, in *Key, opts ...grpc.CallOption) (*Value, error) {
	out := new(Value)
	err := grpc.Invoke(ctx, "/byzq.AuthRegister/Read", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authRegisterClient) Write(ctx context.Context, in *Value, opts ...grpc.CallOption) (*WriteResp, error) {
	out := new(WriteResp)
	err := grpc.Invoke(ctx, "/byzq.AuthRegister/Write", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// Server API for AuthRegister service

type AuthRegisterServer interface {
	Read(context.Context, *Key) (*Value, error)
	Write(context.Context, *Value) (*WriteResp, error)
}

func RegisterAuthRegisterServer(s *grpc.Server, srv AuthRegisterServer) {
	s.RegisterService(&_AuthRegister_serviceDesc, srv)
}

func _AuthRegister_Read_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Key)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthRegisterServer).Read(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/byzq.AuthRegister/Read",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthRegisterServer).Read(ctx, req.(*Key))
	}
	return interceptor(ctx, in, info, handler)
}

func _AuthRegister_Write_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Value)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthRegisterServer).Write(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/byzq.AuthRegister/Write",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthRegisterServer).Write(ctx, req.(*Value))
	}
	return interceptor(ctx, in, info, handler)
}

var _AuthRegister_serviceDesc = grpc.ServiceDesc{
	ServiceName: "byzq.AuthRegister",
	HandlerType: (*AuthRegisterServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Read",
			Handler:    _AuthRegister_Read_Handler,
		},
		{
			MethodName: "Write",
			Handler:    _AuthRegister_Write_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: fileDescriptorAuthq,
}
...
func (m *Key) MarshalTo(data []byte) (int, error) {
	...
	if len(m.Key) > 0 {
		data[i] = 0xa
		i++
		i = encodeVarintAuthq(data, i, uint64(len(m.Key)))
		i += copy(data[i:], m.Key)
	}
	return i, nil
}
...
func (m *Value) MarshalTo(data []byte) (int, error) {
	...
	if m.Timestamp != 0 {
		data[i] = 0x10
		i++
		i = encodeVarintAuthq(data, i, uint64(m.Timestamp))
	}
	if len(m.Value) > 0 {
		data[i] = 0x1a
		i++
		i = encodeVarintAuthq(data, i, uint64(len(m.Value)))
		i += copy(data[i:], m.Value)
	}
	if len(m.Signature) > 0 {
		data[i] = 0x22
		i++
		i = encodeVarintAuthq(data, i, uint64(len(m.Signature)))
...
func encodeFixed64Authq(data []byte, offset int, v uint64) int {
	data[offset] = uint8(v)
...
func encodeFixed32Authq(data []byte, offset int, v uint32) int {
	data[offset] = uint8(v)
	data[offset+1] = uint8(v >> 8)
	data[offset+2] = uint8(v >> 16)
	data[offset+3] = uint8(v >> 24)
...
func encodeVarintAuthq(data []byte, offset int, v uint64) int {
	for v >= 1<<7 {
...
func (m *Value) Size() (n int) {
	...
	if m.Timestamp != 0 {
		n += 1 + sovAuthq(uint64(m.Timestamp))
	}
	l = len(m.Value)
	if l > 0 {
		n += 1 + l + sovAuthq(uint64(l))
...
func sozAuthq(x uint64) (n int) {
	return sovAuthq(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
...
func valueToStringAuthq(v interface{}) string {
...
func (m *Key) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		default:
			iNdEx = preIndex
			skippy, err := skipAuthq(data[iNdEx:])
			if err != nil {
				return err
			}
			if skippy < 0 {
...
func skipAuthq(data []byte) (n int, err error) {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		var wire uint64
		...
		case 2:
			...
			iNdEx += length
			if length < 0 {
				return 0, ErrInvalidLengthAuthq
			}
			return iNdEx, nil
		case 3:
			for {
...
var (
	ErrInvalidLengthAuthq = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowAuthq   = fmt.Errorf("proto: integer overflow")
)

func init() { proto.RegisterFile("authq.proto", fileDescriptorAuthq) }

var fileDescriptorAuthq = []byte{
	// 262 bytes of a gzipped FileDescriptorProto
	,
	...
	0xc7, 0x72, 0x0c, 0x49, 0x6c, 0xe0, 0x60, 0x34, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0xee, 0x3c,
	0x4a, 0x1a, 0x55, 0x01, 0x00, 0x00,
}
