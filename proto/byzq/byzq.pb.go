...
func (*Empty) Descriptor() ([]byte, []int) { return fileDescriptorByzq, []int{0} }
...
func (*State) Descriptor() ([]byte, []int) { return fileDescriptorByzq, []int{1} }
...
func (*WriteResponse) Descriptor() ([]byte, []int) { return fileDescriptorByzq, []int{2} }

func init() {
	proto.RegisterType((*Empty)(nil), "byzq.Empty")
	proto.RegisterType((*State)(nil), "byzq.State")
...
func (m *State) MarshalTo(data []byte) (int, error) {
	...
	if m.Value != 0 {
		data[i] = 0x8
		i++
		i = encodeVarintByzq(data, i, uint64(m.Value))
	}
	if m.Timestamp != 0 {
		data[i] = 0x10
		i++
...
func init() { proto.RegisterFile("proto/byzq/byzq.proto", fileDescriptorByzq) }

var fileDescriptorByzq = []byte{
	// 243 bytes of a gzipped FileDescriptorProto
	,
	...
	0xc4, 0x06, 0x0e, 0x26, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x4c, 0x20, 0x3f, 0x94, 0x3f,
	0x01, 0x00, 0x00,
}
